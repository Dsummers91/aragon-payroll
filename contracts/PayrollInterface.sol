...
contract PayrollInterface {
  ...
  function getEmployee(uint256 employeeId) constant returns (address employeeAddress, uint256 employeeID, uint256 startDate,address[] tokens, uint256[] distribution); // Return all important info too
